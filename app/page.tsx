        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="hover:border-black h-full flex flex-col">
              ...
              <CardContent className="flex-grow">
                <CardDescription className="text-center">
                  Cadastre, edite e gerencie informações das suas empresas.
                  Mantenha todos os dados organizados em um só lugar.
                </CardDescription>
              </CardContent>
          ...
          >
            <Card className="hover:border-black h-full flex flex-col">
              ...
              <CardContent className="flex-grow">
                <CardDescription className="text-center">
                  Emita, controle e acompanhe suas notas fiscais. Simplifique o
